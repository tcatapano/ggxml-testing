...
-->
    ...
    <sch:pattern name="illegal nesting">
        <sch:rule id="tmt" context="treatment">
<sch:report test="descendant::treatment">
ERROR: a <sch:name/> element should not contain another <sch:name/> element </sch:report>
        </sch:rule>
        <sch:rule context="materialsCitation">
<sch:report test="descendant::materialsCitation">
ERROR: a <sch:name/> element should not contain another <sch:name/> element </sch:report>
        </sch:rule>
